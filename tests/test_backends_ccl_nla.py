"""Unit tests for ``plima.backends.ccl.nla``."""
...
def test_make_ccl_nla_ia_bias_uses_default_amplitude() -> None:
    """Tests that NLA IA bias defaults to the requested constant amplitude."""
...
def test_make_ccl_nla_ia_bias_uses_precomputed_amplitude() -> None:
    """Tests that NLA IA bias uses a precomputed amplitude when supplied."""
    z = np.array([0.0, 0.5, 1.0])
...
def test_make_ccl_nla_ia_bias_accepts_scalar_amplitude_for_scalar_z() -> None:
    """Tests that NLA IA bias accepts scalar amplitude for scalar redshift."""
...
def test_make_ccl_nla_ia_bias_accepts_scalar_amplitude_for_array_z() -> None:
    """Tests that NLA IA bias broadcasts scalar amplitude over redshift arrays."""
    z = np.array([0.0, 0.5, 1.0])
...
def test_make_ccl_nla_ia_bias_rejects_amplitude_shape_mismatch() -> None:
    """Tests that NLA IA bias rejects amplitudes with a mismatched shape."""
    z = np.array([0.0, 0.5, 1.0])
...
def test_make_ccl_nla_ia_bias_rejects_nonfinite_amplitude(
...
def test_make_ccl_nla_ia_bias_preserves_redshift_and_amplitude_order() -> None:
    """Tests that NLA IA bias preserves the input redshift and amplitude order."""
...
def test_make_ccl_nla_ia_bias_returns_copies_as_float_arrays() -> None:
    """Tests that NLA IA bias returns float arrays independent of integer inputs."""
    z = np.array([1, 0])
...
def test_make_ccl_nla_ia_bias_accepts_list_redshift_and_amplitude() -> None:
    """Tests that NLA IA bias accepts list inputs."""
    z = [0.0, 0.5, 1.0]
...
def test_make_ccl_nla_ia_bias_returns_two_arrays() -> None:
    """Tests that NLA IA bias returns the CCL tuple structure."""
    result = make_ccl_nla_ia_bias([0.0, 0.5], amplitude=[1.0, 2.0])
...
def test_make_ccl_nla_ia_bias_returns_arrays_with_matching_shapes() -> None:
    """Tests that NLA IA bias returns arrays with matching shapes."""
    z = np.array([0.0, 0.5, 1.0])
...
def test_make_ccl_nla_ia_bias_returns_independent_arrays() -> None:
    """Tests that NLA IA bias returns arrays independent of input arrays."""
    z = np.array([0.0, 0.5, 1.0])
    amplitude = np.array([1.0, 2.0, 3.0])
...
def test_make_ccl_nla_ia_bias_rejects_empty_redshift() -> None:
    """Tests that NLA IA bias rejects empty redshift arrays."""
...
def test_make_ccl_nla_ia_bias_rejects_empty_amplitude_for_nonempty_redshift() -> (
    ...
    with pytest.raises(
        ...
        make_ccl_nla_ia_bias(z, amplitude=np.array([]))


def test_make_ccl_nla_ia_bias_accepts_length_one_amplitude_array() -> None:
    """Tests that NLA IA bias accepts length one amplitude arrays."""
    z = np.array([0.0, 0.5, 1.0])
